...
HOOK_NAME = 'sceptre-terminationprotection-hook'
# the hook call in sceptre e.g. !command_name.
HOOK_COMMAND_NAME = 'set_stack_termination_protection'
...
HOOK_AUTHOR = 'craighurley'
# if multiple use single string with commas.
HOOK_AUTHOR_EMAIL = 'none@example.com'
HOOK_URL = 'https://github.com/craighurley/{}'.format(HOOK_NAME)
